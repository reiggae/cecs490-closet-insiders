...
// void updateClothes(vector<Shirt>& closet){
//     string ChosenID;
//     cout << "Enter the shirt ID that you want to update" << endl;
//     getline(cin, ChosenID);
...
//     if (it != closet.end()){
//         cout << "Shirt ID found" << endl;
//         cout << "Do you want to add or remove details?" << endl;
